...
if ($('#configure').length) {
    var analytics_vm = new Vue({
        ...
        watch: {
            ...
            property_id: function property_id() {
                var me = this;
        ...
        methods: {
            post_get_config: function post_get_config(callback) {
                var me = this;
            ...
            update_steps: function update_steps() {
                var me = this;
            ...
            // Save Project Name
            set_project_name: function set_project_name(project_name) {
                var me = this;
            ...
            // ACCOUNTS & PROPERTIES
            post_get_accounts: function post_get_accounts() {
                var me = this;
            ...
            post_new_account: function post_new_account(account_name) {
                var me = this;
            ...
            // Save Account
            post_save_account: function post_save_account() {
                var me = this;
            ...
            post_get_web_properties: function post_get_web_properties() {
                var me = this;
            ...
            post_new_property: function post_new_property(property_name) {
                var me = this;
            ...
            // Save Property
            post_save_property: function post_save_property() {
                var me = this;
            ...
            reset_accounts: function reset_accounts() {
                var me = this;
            ...
            reset_properties: function reset_properties() {
                var me = this;
